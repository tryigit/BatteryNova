...
resetprop persist.vendor.sys.activity_resumption_boost false

# resetprop debug.gr.swapinterval 0

# Gpu Optimization @tryigitx
resetprop debug.sf.enable_gl_backpressure 1
resetprop persist.sys.gpu.early_app_start false
